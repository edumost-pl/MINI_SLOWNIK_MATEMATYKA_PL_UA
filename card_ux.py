...
NIE_POMYL: dict[str, list[tuple[str, str]]] = {
    ...
    "liczba naturalna": [("1, 2, 3…", "nie ułamki"), ("do liczenia", "≠ liczby ujemne")],
    "wartość pozycyjna": [("3 w 35 = 3 dziesiątki", "3 w 3 = 3 jednostki"), ("miejsce = wartość", "ta sama cyfra ≠ to samo")],
    "liczba porządkowa": [("1. = pierwszy", "1 = jeden"), ("kolejność", "≠ ile")],
    "zero": [("0 = nic", "nie „pusty znak”"), ("0 w naturalnych: zależnie od umowy", "0 ∈ ℤ zawsze")],
    ...
    "oś liczbowa": [("w lewo mniejsze", "w prawo większe"), ("zero pośrodku (całkowite)", "≠ linia czasu")],
    "wartość bezwzględna": [("|−5| = 5", "|5| = 5"), ("odległość od 0", "≠ liczba przeciwna")],
    "liczba przeciwna": [("przeciwna do 3 = −3", "przeciwna do −3 = 3"), ("suma = 0", "≠ wartość bezwzględna")],
    "dodawanie": [("suma = wynik +", "składniki = to, co dodajesz"), ("kolejność nie zmienia sumy", "≠ odejmowanie")],
    "suma": [("suma = wynik dodawania", "nie „plus” sam"), ("2+3=5 → suma 5", "składniki 2 i 3")],
    "odejmowanie": [("różnica = wynik −", "odjemna − odjemnik"), ("kolejność ważna", "≠ dodawanie")],
    "różnica": [("różnica = wynik odejmowania", "8−3=5 → różnica 5"), ("nie myl z „różnicą temperatur” jako pojęciem", "tu: wynik −")],
    "składnik": [("składnik → dodawanie", "czynnik → mnożenie"), ("2+5: składniki 2 i 5", "≠ odjemnik")],
    "odjemna i odjemnik": [("odjemna − odjemnik", "9−4: 9 odjemna, 4 odjemnik"), ("kolejność ważna", "≠ składniki")],
    "mnożenie": [("× = dodawanie tej samej", "3×4 = 3+3+3+3"), ("iloczyn = wynik", "≠ dzielenie")],
    ...
    "przemienność": [("a+b = b+a", "a·b = b·a"), ("działa dla + i ×", "nie dla − i :")],
    "dzielenie": [("iloraz = wynik :", "dzielna : dzielnik"), ("związek z ×", "≠ odejmowanie")],
    "iloraz": [("iloraz = wynik dzielenia", "12:3=4 → iloraz 4"), ("≠ reszta", "reszta to co zostaje")],
    "dzielna i dzielnik": [("dzielna : dzielnik", "12:3 → 12 dzielna, 3 dzielnik"), ("kolejność ważna", "≠ czynniki")],
    "z resztą": [("14:3 = 4 r.2", "nie „zawsze wychodzi równo”"), ("reszta < dzielnik", "≠ ułamek")],
    "nawiasy": [("najpierw ( )", "potem × : i + −"), ("nawiasy zmieniają kolejność", "nie od lewej „na siłę”")],
