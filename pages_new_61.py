    ...
    return P(
        ...
        [
            C(
                ...
                "право / ліво",
                "👉 prawo · 👈 lewo",
                "Na sobie: prawa ręka, lewa noga. Na obrazku: mówimy o prawej i lewej stronie postaci, którą widzisz.",
                "На собі: права рука, ліва нога. На малюнку: говоримо про праву і ліву сторону персонажа, якого ти бачиш.",
                klasa="klasy 1–3",
                media="diagram",
            ),
            C(
            ...
            C(
                ...
                "перед / за / біля",
                "przed · za · obok",
                "Przed = znajduje się przed innym obiektem. Za = znajduje się za innym obiektem. Obok = znajduje się z boku.",
                "Перед = знаходиться перед іншим предметом. За = знаходиться позаду іншого предмета. Біля = знаходиться збоку або поруч.",
                klasa="klasy 1–3",
                media="cover",
            ),
            C(
