...
PAGE_LIFE = {
    1: ("Liczby widzisz w sklepie, na ulicy, w grze — wszędzie, gdzie coś liczysz.",
        "Числа бачиш у магазині, на вулиці, в грі — скрізь, де щось лічиш."),
    ...
    4: ("Punkty w grze, cukierki, zakupy: ile razem? ile zostanie?",
        "Очки в грі, цукерки, покупки: скільки разом? скільки лишиться?"),
    5: ("Rzędy ławek, pudełka kredek, tabliczka — mnożenie to szybkie dodawanie.",
        "Ряди парт, коробки олівців, таблиця — множення = швидке додавання."),
    6: ("Rozdajesz cukierki po równo w klasie — to właśnie dzielenie.",
        "Роздаєш цукерки порівну в класі — це саме ділення."),
    ...
    23: ("Ile trwa lekcja albo film? Czas liczymy w godzinach, minutach, sekundach.",
        "Скільки триває урок або фільм? Час рахуємо в годинах, хвилинах, секундах."),
    ...
    26: ("Zakupy, reszta, kieszonkowe — pieniądze liczymy jak ułamki dziesiętne.",
        "Покупки, решта, кишенькові — гроші рахуємо як десяткові дроби."),
    27: ("Samochód w podróży, mapa wycieczki — prędkość, droga, skala.",
        "Авто в подорожі, мапа екскурсії — швидкість, шлях, масштаб."),
    28: ("Od punktu rysujesz odcinek, prostą, wielokąt — podstawy geometrii.",
        "Від точки малюєш відрізок, пряму, многокутник — основи геометрії."),
    29: ("Znaki drogowe, okna, dachy — trójkąty i czworokąty wokół Ciebie.",
        "Дорожні знаки, вікна, дахи — трикутники й чотирикутники навколо тебе."),
...
PAGE_MISTAKE = {
    1: ("Cyfra to nie to samo co liczba: 3 to cyfra; 35 to liczba z dwóch cyfr.",
        "Цифра — не те саме, що число: 3 — цифра; 35 — число з двох цифр."),
    ...
    4: ("Przy odejmowaniu nie odwracaj kolejności: 9−4, nie 4−9.",
        "При відніманні не міняй порядок: 9−4, не 4−9."),
    5: ("Tabliczka: 7×8 to nie 7+8. Mnożenie = wielokrotne dodawanie.",
        "Таблиця: 7×8 — це не 7+8. Множення = багаторазове додавання."),
    6: ("Dzielna / dzielnik: w 12:3 liczba 12 jest dzielną (co dzielimy), 3 — dzielnikiem.",
        "Ділене / дільник: у 12:3 число 12 — ділене, 3 — дільник."),
